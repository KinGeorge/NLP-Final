...
def main():
    ...
    dataset = Poetry_Dataset(w1, word_2_index, all_data, args.Word2Vec,args.model)
    ...
    torch.save(model.state_dict(), args.save_path + args.model + '_' + str(args.num_epochs)+'.pth')
